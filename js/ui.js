...
const updateUI = async () => {
  try {
    ...
    if (isAuthenticated) {
      ...
      document.getElementById('signupArea').classList.add('hidden'); // Show signup area
      eachElement(".profile-image", (e) => (e.src = user.picture));
      eachElement(".user-name", (e) => (e.innerText = user.name));
      eachElement(".user-email", (e) => (e.innerText = user.email));
      eachElement(".auth-invisible", (e) => e.classList.add("hidden"));
      eachElement(".auth-visible", (e) => e.classList.remove("hidden"));
      eachElement(".profile-image", (e) => e.classList.remove("hidden"));
      eachElement(".user-name", (e) => e.classList.remove("hidden"));
    } else {
      eachElement(".auth-invisible", (e) => e.classList.remove("hidden"));
      eachElement(".auth-visible", (e) => e.classList.add("hidden"));
      eachElement(".profile-image", (e) => e.classList.add("hidden"));
      eachElement(".user-name", (e) => e.classList.add("hidden"));
      document.getElementById('signupArea').classList.add('hidden');
      document.getElementById('changePasswordArea').classList.add('hidden');
    }
  } catch (err) {
